        ...
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="{{ route('code.verify.process') }}" method="POST" onsubmit="showLoading(this)">
            ...
            <div class="form-group mb-3">
              <input type="hidden" name="token" class="form-control" value="{{ $tokenData->token }}" >
              <input type="text" class="form-control" name="code" placeholder="Enter code from your email" value="{{ old('code') }}">
              @error('code')
